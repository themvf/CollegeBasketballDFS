...
def build_market_correlation_ai_review_packet(
    *,
        ...
        trend_rows.append(
            {
                ...
                "corr_total_vs_vegas_points_line_spearman": _safe_spearman(
                    pd.to_numeric(day["game_total_line"], errors="coerce"),
                    pd.to_numeric(day["vegas_points_line"], errors="coerce"),
                ),
    ...
    global_quality = {
        ...
        "total_line_vs_vegas_points_line_spearman": _safe_spearman(
            frame["game_total_line"],
            frame["vegas_points_line"],
        ),
